            ...
            <div>
              ...
              >
                ...
                {postState.comments.length !== 0 && (
                  <div style={{ maxHeight: 'calc(80vh - 140px)', overflowY: 'auto', padding: '0.5rem 0.6rem 6.5rem' }}>
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                          ...
                          <div>
                            ...
                            <p style={{ margin: 0, color: '#666' }}>@{comment.userId?.username || 'unknown'}</p>
                          </div>
                        </div>

                        <p style={{ margin: 0, color: '#111', paddingLeft: '3.2rem' }}>{comment.body}</p>
                      </div>
                    ))}
                  </div>
                )}
